...
public:
  ...
  enum {
    ...
    RuleForExpr = 46, RuleReturnStmt = 47, RuleExprStmt = 48, RuleStructInstFields = 49, 
    RuleAssignmentTarget = 50, RuleAssignment = 51, RuleExpr = 52, RuleMatchCase = 53, 
    RuleArgs = 54, RuleLiteral = 55, RulePrimary = 56
  };
